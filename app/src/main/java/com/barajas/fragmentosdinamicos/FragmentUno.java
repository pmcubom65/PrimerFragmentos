...
public class FragmentUno extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View v=(View)inflater.inflate(R.layout.fragment_fragment_uno, container, false);
       b=(Button) v.findViewById(R.id.buttonuno);
...
public void botonClick(View view) {
        switch (view.getId()) {
            case R.id.buttonuno: Toast.makeText(getContext(), "Fragmento uno", Toast.LENGTH_LONG).show();
        }
}
